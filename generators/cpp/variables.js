...
Blockly.cpp['define_get'] = function(block) {
    // Variable getter.
...
Blockly.cpp['define_declare'] = function(block) {
    // Variable declare.
    ...
    Blockly.cpp.definitions_['define_' + varName] = code;
    return null;
};
...
Blockly.cpp['variables_pointer_get'] = function(block) {
    // Variable getter.
    var code = Blockly.cpp.variableDB_.getName(block.getFieldValue('VAR'),
        Blockly.Variables.NAME_TYPE);
    code = Blockly.Blocks.checkUnselect(code);
...
Blockly.cpp['variables_pointer_set'] = function(block) {
    // Variable setter.
    var argument0 = Blockly.cpp.valueToCode(block, 'VALUE',
            Blockly.cpp.ORDER_ASSIGNMENT) || '0';
    var argument1 = Blockly.cpp.valueToCode(block, 'VAR',
        Blockly.cpp.ORDER_ASSIGNMENT);
    argument1 = Blockly.Blocks.checkUnselect(argument1);
    return argument1 + ' = ' + argument0 + ';\n';
};

Blockly.cpp['variables_pointer_declare'] = function(block) {
    // Variable declare.
    var argument0 = Blockly.cpp.valueToCode(block, 'VALUE',
            Blockly.cpp.ORDER_ASSIGNMENT) || '0';
    var varName = Blockly.cpp.variableDB_.getName(
...
Blockly.cpp['variables_pointer_&'] = function(block) {
    var argument0 = Blockly.cpp.valueToCode(block, 'VALUE', Blockly.cpp.ORDER_ASSIGNMENT);
    return ['&' + argument0, Blockly.cpp.ORDER_ATOMIC];
};
...
Blockly.cpp['variables_array_get'] = function(block) {
...
Blockly.cpp['variables_array_set'] = function(block) {
    // Variable setter.
    var argument0 = Blockly.cpp.valueToCode(block, 'VALUE',
            Blockly.cpp.ORDER_ASSIGNMENT) || '0';
    var varName = Blockly.cpp.variableDB_.getName(
...
Blockly.cpp['variables_array_declare'] = function(block) {
    // Variable declare.
    var argument0 = Blockly.cpp.valueToCode(block, 'VALUE',
            Blockly.cpp.ORDER_ASSIGNMENT) || '0';
    var varName = Blockly.cpp.variableDB_.getName(
