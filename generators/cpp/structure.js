...
goog.provide('Blockly.cpp.structure');

goog.require('Blockly.cpp');


Blockly.cpp['structure_define'] = function(block) {
  var structName = Blockly.cpp.variableDB_.getName(
  ...
  for (var x = 0; x < block.members_.length; x++) {
    mems[x] = Blockly.cpp.variableDB_.getName(block.members_[x],
...
Blockly.cpp['structure_declare'] = function(block) {
  var type = Blockly.cpp.variableDB_.getName(
...
Blockly.cpp['structure_get'] = function(block) {
  var name = Blockly.cpp.variableDB_.getName(
    block.getFieldValue('NAME'), null);
  var structMem = Blockly.cpp.variableDB_.getName(
...
Blockly.cpp['structure_set'] = function(block) {
